...
class VenueServicesSection extends ConsumerWidget {
  const VenueServicesSection({super.key, required this.venueId});
      ...
      children: [
        ...
        AnimatedSwitcher(
          ...
          child: servicesAsync.when(
            loading: () =>
                const _VenueServicesLoading(key: ValueKey('loading')),
    ...
    return Column(
      children: [
        for (var i = 0; i < services.length; i++) ...[
          _VenueServiceCard(venueId: venueId, service: services[i]),
...
class _VenueServiceCard extends StatelessWidget {
  const _VenueServiceCard({required this.venueId, required this.service});
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    if (service.unitType != null &&
                      ...
                      _ServiceChip(icon: Iconsax.box, label: service.unitType!),
              ...
              if (service.units.isNotEmpty)
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border(
                      top: BorderSide(
                        color: context.adaptiveDivider.withValues(alpha: 0.8),
                      ),
                    ),
                  ),
                  child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: url == null || url.isEmpty
          ? Icon(Iconsax.box, color: context.primaryColor, size: 24)
          : null,
    );
  }
}
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Iconsax.box, color: context.adaptiveTextSecondary),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Text(
